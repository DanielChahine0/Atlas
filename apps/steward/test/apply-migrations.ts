...
// migrations/0001_init_core.sql here BEFORE any test runs. The migrations array is
// read on the Node side in vitest.config.ts and surfaced via `provide`/`inject`.
//
