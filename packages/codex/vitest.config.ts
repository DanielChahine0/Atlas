...
//
// packages/codex's read() is exercised with an injected (stubbed) Drive `fetch` + a
// stubbed CONFIG KV — no live network, no wrangler config pointed at here; only
// nodejs_compat is required to satisfy the toolchain.
